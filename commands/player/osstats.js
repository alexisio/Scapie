...
module.exports = class OSStatsCommand extends Commando.Command {
    constructor(client) {
        super(client, {
            name: 'osstats',
            aliases: ['osstats','07stats', 'osrsstats'],
            group: 'player',
            memberName: 'osstats',
            description: 'Get players stats on oldschool',
            examples: ['OSStats fanclub'],
        });
    }
